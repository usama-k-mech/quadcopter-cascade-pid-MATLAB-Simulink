...
% NOTE: these physical parameters are mirrored inside quad_plant_fcn.m.
...
B_torque = 0.0382;        % torque-to-thrust ratio kQ/kT [m] (Luukkonen: 1.14e-7 / 2.98e-6)
...
att_cmd_limit  = 18 * pi/180;  % max desired roll/pitch [rad] = 18 degrees
...
fprintf('  3. Run plot_results_quad  (static figures + RMSE metrics)\n');
fprintf('========================================\n');